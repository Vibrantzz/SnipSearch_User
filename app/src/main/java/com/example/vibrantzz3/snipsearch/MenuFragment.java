        ...
        protected void onPostExecute(final String result) {
            ...
            try {
                ...
                for(int i=0;i<jArray.length();i++){
                    ...
                    MenuData.add(new userPhotos( json_data.getString(TAG_ID),json_data.getString(TAG_PHOTO),"",json_data.getString(TAG_SNAME),"",json_data.getString(TAG_SID)));
                }


                myrv=(RecyclerView) view.findViewById(R.id.menu_recycler);
