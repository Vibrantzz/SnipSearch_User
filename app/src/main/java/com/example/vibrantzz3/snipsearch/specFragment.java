...
public class specFragment extends Fragment {
    ...
    RecyclerView myrv;
    private static final String url_spec = "http://test.epoqueapparels.com/Salon/Salon_App/specfragment.php";
        ...
        protected void onPostExecute(final String result) {
            ...
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    ...
                    specData.add(new Spec( json_data.getString(TAG_ID), json_data.getString(TAG_NAME), json_data.getString(TAG_PIC)));
                }
