...
public class SpecList extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    List<Salon> specData;
    String id,uid,fname,upic;
    SalonListRecyclerViewAdapter myAdapter;
    JSONObject jsonObject;
    RecyclerView myrv;
    private static final String url_speclist = "http://test.epoqueapparels.com/Salon/Salon/Salon_App/speclist.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SpecList.this , User.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_appointment) {
            Intent intent = new Intent(SpecList.this , ViewAppointments.class);
            intent.putExtra("id",uid);
            startActivity(intent);
        } else if (id == R.id.nav_bm) {

            Intent intent = new Intent(SpecList.this , ViewBookmarksActivity.class);
            intent.putExtra("id",uid);
            startActivity(intent);

        } else if (id == R.id.nav_fave) {
            Intent intent = new Intent(SpecList.this , ViewFavouritesActivity.class);
            intent.putExtra("id",uid);
            startActivity(intent);


        } else if (id == R.id.nav_notif) {
            Intent intent = new Intent(SpecList.this , ViewOffers.class);
            startActivity(intent);

        }else if (id == R.id.nav_settings) {
            Intent intent = new Intent(SpecList.this , Settings.class);
            startActivity(intent);
            ...
            editor.clear();
            editor.commit();
            Intent intent = new Intent(SpecList.this , MainActivity.class);
            startActivity(intent);
                ...
                public void run() {
                    try {
                        ...
                        for(int i=0;i<jArray.length();i++){
                            ...
                            specData.add(new Salon(json_data.getString(TAG_NAME), json_data.getString(TAG_LOC), json_data.getString(TAG_RATE), json_data.getString(TAG_PIC), json_data.getString(TAG_SID),id,json_data.getString(TAG_RCOUNT)));

                        }


                        myrv=(RecyclerView) findViewById(R.id.specl_recycler);
                        myAdapter=new SalonListRecyclerViewAdapter(SpecList.this,specData);
