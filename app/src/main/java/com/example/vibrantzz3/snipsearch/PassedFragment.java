...
public class PassedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            aData.add(new Appointments( "uid","id","name","location","thumbnail","udate","utime"));
        }


        myrv = (RecyclerView) view.findViewById(R.id.passed_recycler);
        AppointmentRecyclerViewAdapter myAdapter = new AppointmentRecyclerViewAdapter(getContext(), aData);
