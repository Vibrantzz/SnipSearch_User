...
public class UpcomingFragment extends Fragment {
    ...
    RecyclerView myrv;
    private static final String url_appt = "http://test.epoqueapparels.com/Salon/Salon_App/upcominglist.php";
        ...
        protected void onPostExecute(final String result) {
            ...
            try {
                ...
                for(int i=0;i<jArray.length();i++){
                    ...
                    aData.add(new Appointments( id,json_data.getString(TAG_SID),json_data.getString(TAG_NAME),json_data.getString(TAG_LOCATION),json_data.getString(TAG_PIC)," on "+json_data.getString(TAG_DATE), "at "+json_data.getString(TAG_TIME)+" has been confirmed. Thank you!","Your appointment for "+json_data.getString(TAG_REQUEST)));
