...
public class AcademyList extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    RecyclerView myrv;
    private static final String url_academylist = "http://test.epoqueapparels.com/Salon/Salon_App/academyFragment.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(AcademyList.this , User.class);
