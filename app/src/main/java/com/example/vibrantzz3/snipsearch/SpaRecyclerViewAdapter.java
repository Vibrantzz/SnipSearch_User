...
public class SpaRecyclerViewAdapter extends RecyclerView.Adapter<SpaRecyclerViewAdapter.MyViewHolder>{

    private Context mContext;
    private List <Spa> sData;

    public SpaRecyclerViewAdapter(Context mContext, List<Spa> sData) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view=mInflater.inflate(R.layout.card_spa,parent,false);
