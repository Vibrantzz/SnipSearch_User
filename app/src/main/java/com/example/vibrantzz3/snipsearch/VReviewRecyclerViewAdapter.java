...
public class VReviewRecyclerViewAdapter extends RecyclerView.Adapter<VReviewRecyclerViewAdapter.MyViewHolder>{

    private Context mContext;
    private List<UReview> uData;

    public VReviewRecyclerViewAdapter(Context mContext, List<UReview> uData) {
