        ...
        protected void onPostExecute(final String result) {
            ...
            try {
                ...
                for(int i=0;i<jArray.length();i++){
                    ...
                    MenuData.add(new userPhotos( json_data.getString(TAG_ID),json_data.getString(TAG_PHOTO),json_data.getString(TAG_UNAME) + " at ",json_data.getString(TAG_SNAME),json_data.getString(TAG_USERID),json_data.getString(TAG_SID)));
                }
