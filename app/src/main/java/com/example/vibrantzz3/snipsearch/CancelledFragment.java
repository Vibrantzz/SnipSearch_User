        ...
        protected void onPostExecute(final String result) {
            ...
            try {
                ...
                for(int i=0;i<jArray.length();i++){
                    ...
                    aData.add(new Appointments( id,json_data.getString(TAG_SID),json_data.getString(TAG_NAME),json_data.getString(TAG_LOCATION),json_data.getString(TAG_PIC)," on "+json_data.getString(TAG_DATE), " at "+json_data.getString(TAG_TIME)+" has been cancelled","Your appointment for "+json_data.getString(TAG_REQUEST)));
